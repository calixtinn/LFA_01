...
\begin{document} 
	...
	\begin{itemize}
		...
		\item \textbf{União de AFD's:}
		
		\item \textbf{Intercessão de AFD's:}
		
		\item \textbf{Diferença de AFD's:}
		
		\item \textbf{Adiciona estado ao AFD:}
		
		\item \textbf{Remove estado do AFD:}
		
		\item \textbf{Adiciona transição ao AFD:}
		
		\item \textbf{Remove Transição do AFD:}
